...
/*   Updated: 2018/10/04 17:14:45 by lfabbro          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			sha256_transform(t_sha256 *ctx, const uint8_t data[])
{
	...
	sha256_transform_bis(ctx, data, &t);
	while (t.i < 64)
	{
		t.t1 = t.h + BSIG1(t.e) + CH(t.e, t.f, t.g) + g_k[t.i] + t.m[t.i];
...
static void		sha256_final_bis(t_sha256 *ctx, uint32_t hash[])
{
	hash[0] = ctx->regs[0];
	hash[1] = ctx->regs[1];
	hash[2] = ctx->regs[2];
